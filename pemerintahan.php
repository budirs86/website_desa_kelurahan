...
<div id="main">
    ...
    <div id="content">
		...
		if (isset($_GET['jenis'])){
			...
			if ($row_content['jenis']=='sambutan'){
				echo '
					 <h2 class="title-top">SAMBUTAN PIMPINAN DAERAH</h2>
					<div>
			...
			if ($row_content['jenis']=='pimpinan'){
				echo '
					 <h2 class="title-top">PIMPINAN DAERAH</h2>
					<div>
					   <p>'.html_entity_decode($row_content['content']).'
					   </p>
					</div> 
				...
				if ($row_content['jenis']=='visi_misi'){
				echo '
					 <h2 class="title-top">VISI MISI DAERAH</h2>
					<div>
					   <p>'.html_entity_decode($row_content['content']).'
					   </p>
					</div> 
				...
				if ($row_content['jenis']=='struktur'){
				echo '
					 <h2 class="title-top">STRUKTUR ORGANISASI</h2>
					<div>
					   <p>'.html_entity_decode($row_content['content']).'
					   </p>
					</div> 
				...
				if ($row_content['jenis']=='lembaga'){
				echo '
					 <h2 class="title-top">KELEMBAGAAN</h2>
					<div>
					   <p>'.html_entity_decode($row_content['content']).'
					   </p>
					</div> 
					...
					if ($row_content['jenis']=='peraturan'){
				echo '
					 <h2 class="title-top">KUMPULAN PERATURAN DAERAH</h2>
					<div>
					   <p>'.html_entity_decode($row_content['content']).'
					   </p>
					</div> 
        ...
        <div id="right-content">
           ...
           <?php include_once('pemerintahan_menu.php');?>
