...
<div id="main">
    ...
    <div id="content">
		...
		if (isset($_GET['jenis'])){
			...
			$qcontent="select * from tbl_produk where jenis='$jenis_dok' limit 1";
			...
			if ($row_content['jenis']=='wisata'){
				echo '
					 <h2 class="title-top">PRODUK WISATA</h2>
					<div>
			...
			if ($row_content['jenis']=='kerajinan'){
				echo '
					 <h2 class="title-top">PRODUK KERAJINAN WARGA</h2>
					<div>
					   <p>'.html_entity_decode($row_content['content']).'
					   </p>
					</div> 
				...
				echo '
					 <h2 class="title-top">PRODUK HASIL ALAM</h2>
					<div>
					   <p>'.html_entity_decode($row_content['content']).'
					   </p>
					</div> 
				...
				if ($row_content['jenis']=='produksi'){
				echo '
					 <h2 class="title-top">PRODUKSI WARGA</h2>
					<div>
					   <p>'.html_entity_decode($row_content['content']).'
					   </p>
					</div> 
        ...
        <div id="right-content">
           ...
           <?php include_once('produk_menu.php');?>
